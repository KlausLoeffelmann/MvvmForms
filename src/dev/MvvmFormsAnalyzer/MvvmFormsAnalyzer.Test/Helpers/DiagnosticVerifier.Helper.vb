...
Namespace TestHelper
    ...
    Partial Public MustInherit Class DiagnosticVerifier
        ...
        Private Shared ReadOnly CorlibReference As MetadataReference = MetadataReference.CreateFromAssembly(GetType(Object).Assembly)
        Private Shared ReadOnly SystemCoreReference As MetadataReference = MetadataReference.CreateFromAssembly(GetType(Enumerable).Assembly)
        Private Shared ReadOnly VisualBasicSymbolsReference As MetadataReference = MetadataReference.CreateFromAssembly(GetType(VisualBasicCompilation).Assembly)
        Private Shared ReadOnly CodeAnalysisReference As MetadataReference = MetadataReference.CreateFromAssembly(GetType(Compilation).Assembly)
